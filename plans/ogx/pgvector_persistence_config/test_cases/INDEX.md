...
| [TC-E2E-003](TC-E2E-003.md) | Base-config-only CR generates no config and reports ConfigGenerationInactive | P1 |
| [TC-E2E-004](TC-E2E-004.md) | Base-config pgvector placeholders resolved from env are unchanged by the fix | P1 |
...
| [TC-E2E-007](TC-E2E-007.md) | Declarative pgvector CR without id derives provider_id and still emits persistence | P1 |
...
| [TC-NEG-003](TC-NEG-003.md) | Base ConfigMap without the watch label fails config generation | P2 |
